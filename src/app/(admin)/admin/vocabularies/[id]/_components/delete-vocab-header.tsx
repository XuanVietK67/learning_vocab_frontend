...
export function DeleteVocabHeaderButton({ id, lemma }: Props) {
  ...
  return (
    <>
      <button
        ...
        className="inline-flex h-10 items-center gap-2 rounded-xl bg-danger-soft px-4 text-sm font-semibold text-danger transition-colors hover:bg-[color:color-mix(in_oklab,var(--danger)_18%,transparent)]"
      >
        ...
        >
          ...
          >
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Permanently removes this vocabulary, all its senses, translations, examples, topic links, and learner progress rows.
            </p>
